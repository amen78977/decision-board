...
**جلسة حقيقية بمخرَج الوكلاء الستة كاملاً بلا تنقيح:** [`docs/DEMO.md`](docs/DEMO.md) — بما فيه نقدُ الحَكَم لترتيبه هو.
...
├── docs/                          ← تركيب · معمارية · اشتقاق · Gemini · ودليل الاشتقاق
